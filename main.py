...
def main():
    ...
    train_idx, val_idx = train_test_split(np.arange(cif10.labels.shape[1]), train_size=0.8, shuffle=True,
    ...
    results = custom_train(convnet, mytrainloader,valloader=myvalloader,
                           testloader=mytestloader, dir=save_dir, model_num=FLAGS.model_num,
